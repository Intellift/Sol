 ...
 */
public interface QueryDslAsymmetricCrudApiController<E extends Identifiable<ID>, D extends Identifiable<ID>, L extends Identifiable<ID>, ID extends Serializable> extends AsymmetricCrudApiController<E, D, L, ID> {
